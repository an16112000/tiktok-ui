...
export function IconClose(props) {
    ...
    return (
        <div {...props}>
            <svg className={styles['"close-icon']} width="16" data-e2e="" height="16" viewBox="0 0 48 48" fill="rgba(22, 24, 35, .34)" xmlns="http://www.w3.org/2000/svg" style={{ margin: "0px 12px" }}>
